                ...
                <div className={toggleState === 1 ? "qualification__content qualification__content-active"
                    ...
                    <div className="qualification__data">
                        <div>
                            ...
                            <span className="qualification__subtitle">Vishwa Vidyalaya Bal Niketan <br /> Bhagalpur, Bihar, India.</span>
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            ...
                            <span className="qualification__subtitle">Chauhan Public School <br /> Bhagalpur, Bihar, India.</span>
                            <div className="qualification__calendar">
                                <HiOutlineCalendar className="qualification__calendar-icon" />
                                2018-2020
                            </div>
                    ...
                    <div className="qualification__data">
                        <div>
                            ...
                            <span className="qualification__subtitle">Lovely Professional University <br /> Phagwara, Punjab, India.</span>
                            <div className="qualification__calendar">
                                <HiOutlineCalendar className="qualification__calendar-icon" />
                                2021-2025
                            </div>
